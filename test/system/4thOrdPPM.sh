...
### Periodic, inertial, Cartesian, 4th-order central, no limiting
...
plot_dir=plot/2D_16_I_C_4_PPM
check_dir=checkpoint/2D_16_I_C_4_PPM
mkdir -p $plot_dir
mkdir -p $check_dir
...
plot_dir=plot/2D_32_I_C_4_PPM
check_dir=checkpoint/2D_32_I_C_4_PPM
mkdir -p $plot_dir
mkdir -p $check_dir
...
plot_dir=plot/2D_64_I_C_4_PPM
check_dir=checkpoint/2D_64_I_C_4_PPM
mkdir -p $plot_dir
mkdir -p $check_dir
...
plot_dir=plot/2D_128_I_C_4_PPM
check_dir=checkpoint/2D_128_I_C_4_PPM
mkdir -p $plot_dir
mkdir -p $check_dir
...
plot_dir=plot/2D_256_I_C_4_PPM
check_dir=checkpoint/2D_256_I_C_4_PPM
mkdir -p $plot_dir
mkdir -p $check_dir
